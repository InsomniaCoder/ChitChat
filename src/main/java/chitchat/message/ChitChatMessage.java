...
public class ChitChatMessage {
        ...
        public ChitChatMessage(MessageType notify, List<java.net.Socket> membersList) {
        ...
        public List<Socket> getMembersList() {
                return membersList;
        }

        public void setMembersList(List<Socket> membersList) {
                this.membersList = membersList;
        }
